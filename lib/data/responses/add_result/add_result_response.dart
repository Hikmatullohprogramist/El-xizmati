...
class AddResultRootResponse with _$AddResultRootResponse {
  ...
  factory AddResultRootResponse.fromJson(Map<String, dynamic> json) => _$AddResultRootResponseFromJson(json);
}
...
class AddResultResponse with _$AddResultResponse {
  ...
  factory AddResultResponse.fromJson(Map<String, dynamic> json) => _$AddResultResponseFromJson(json);
}
