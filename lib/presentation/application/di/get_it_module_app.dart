import 'package:El_xizmati/presentation/features/auth/sp_start/auth_start_cubit.dart';
...
import 'package:El_xizmati/presentation/features/ad/ad_detail/features/installment_info/installment_info_cubit.dart';
import 'package:El_xizmati/presentation/features/ad/ad_list/ad_list_cubit.dart';
import 'package:El_xizmati/presentation/features/ad/ad_list_by_type/ad_list_by_type_cubit.dart';
import 'package:El_xizmati/presentation/features/ad/user_ad_detail/user_ad_detail_cubit.dart';
import 'package:El_xizmati/presentation/features/auth/face_id/confirmation/face_id_confirmation_cubit.dart';
...
import 'package:El_xizmati/presentation/features/auth/sp_otp_confirm/otp_confirmation_cubit.dart';
...
import 'package:El_xizmati/presentation/features/common/user_warehouse_selection/user_warehouse_selection_cubit.dart';
import 'package:El_xizmati/presentation/features/creation/ad_creation_result/ad_creation_result_cubit.dart';
import 'package:El_xizmati/presentation/features/creation/order_creation/order_creation_cubit.dart';
import 'package:El_xizmati/presentation/features/creation/product_ad_creation/product_ad_creation_cubit.dart';
import 'package:El_xizmati/presentation/features/creation/request_ad_creation/request_ad_creation_cubit.dart';
import 'package:El_xizmati/presentation/features/creation/service_ad_creation/service_ad_creation_cubit.dart';
...
import 'package:El_xizmati/presentation/features/home/features/category/features/sub_category_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/dashboard/dashboard_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/billing_transactions/billing_transactions_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/billing_transactions/features/filter/billing_transaction_filter_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/identity_verification/identity_verification_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/profile_edit/profile_edit_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/profile_view/profile_view_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_active_sessions/user_active_sessions_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_address/user_addresses_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_ads/features/ad_list/user_ad_list_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_ads/user_ads_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_cards/user_cards_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_orders/features/user_order_cancel/user_order_cancel_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_orders/features/user_order_info/user_order_info_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_orders/features/user_order_list/user_order_list_cubit.dart';
import 'package:El_xizmati/presentation/features/home/features/profile/features/user_orders/user_orders_cubit.dart';
...
extension GetItModuleApp on GetIt {
  Future<void> appModule() async {
    ...
    registerFactory(() => InstallmentInfoCubit(get(), get(), get()));
