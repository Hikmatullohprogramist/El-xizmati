...
import 'ad_list_actions_cubit.dart';

@RoutePage()
class AdListActionsPage extends BasePage<AdListActionsCubit, AdListActionsState, AdListActionsEvent> {
  ...
  @override
  void onEventEmitted(BuildContext context, AdListActionsEvent event) {
    switch (event.type) {
      case AdListActionsEventType.closeOnSuccess:
        context.router.pop(null);
    }
  }

  @override
  Widget onWidgetBuild(BuildContext context, AdListActionsState state) {
    return SizedBox(
