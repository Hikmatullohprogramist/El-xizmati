import 'package:onlinebozor/presentation/features/auth/eds/request/gost_28147_engine.dart';
import 'package:onlinebozor/presentation/features/auth/eds/request/key_parameter.dart';
import 'package:onlinebozor/presentation/features/auth/eds/request/parameters_with_sbox.dart';
...
class OzDSt1106Digest {
  ...
  List<List<int>> _C = new List.filled(4,  List.filled(0,0));
