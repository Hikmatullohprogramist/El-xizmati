...
@RoutePage()
class FaceIdConfirmationPage extends BasePage<FaceIdConfirmationCubit, FaceIdConfirmationState, FaceIdConfirmationEvent> {
  ...
  Widget _buildActionButton(BuildContext context, FaceIdConfirmationState state) {
    return Positioned(
      bottom: 10,
      left: 10,
      right: 10,
  ...
  Widget _buildShowPicture(BuildContext context, FaceIdConfirmationState state) {
    return Scaffold(
