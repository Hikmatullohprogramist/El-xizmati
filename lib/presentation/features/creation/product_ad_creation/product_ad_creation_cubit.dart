...
part 'product_ad_creation_state.dart';

@Injectable()
class ProductAdCreationCubit
    extends BaseCubit<ProductAdCreationState, ProductAdCreationEvent> {
  ProductAdCreationCubit(
    this._adCreationRepository,
    this._userRepository,
    this._userAddressRepository,
  ) : super(const ProductAdCreationState());
  ...
  void setSelectedAnotherCategory(Category category) {
      ...
      if (newImages.isNotEmpty) {
        ...
        if (addedCount >= maxCount) {
          emitEvent(ProductAdCreationEvent(
            ProductAdCreationEventType.onOverMaxCount,
