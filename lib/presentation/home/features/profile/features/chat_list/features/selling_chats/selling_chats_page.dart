...
import 'package:onlinebozor/presentation/home/features/profile/features/chat_list/features/selling_chats/cubit/selling_chats_cubit.dart';
...
class SellingChatsPage extends BasePage<SellingChatsCubit, SellingChatsBuildable,
  ...
  @override
  Widget onWidgetBuild(BuildContext context, SellingChatsBuildable state) {
    return Scaffold(
