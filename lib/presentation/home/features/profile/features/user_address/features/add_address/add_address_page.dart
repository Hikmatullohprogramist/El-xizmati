...
class AddAddressPage extends BasePage<AddAddressCubit, AddAddressBuildable,
  ...
  Widget _buildRegionBlock(BuildContext context, AddAddressBuildable state) {
    return Container(
      color: Colors.white,
      padding: EdgeInsets.symmetric(horizontal: 16, vertical: 20),
      child: Column(
  ...
  Widget _buildAdditionalInfo(BuildContext context, AddAddressBuildable state) {
    return Container(
      color: Colors.white,
      padding: EdgeInsets.symmetric(horizontal: 16, vertical: 20),
      child: Column(
  ...
  _buildFooterBlock(BuildContext context, AddAddressBuildable state) {
    return Container(
      color: Colors.white,
      padding: EdgeInsets.symmetric(horizontal: 16, vertical: 20),
      child: Column(
  ...
  _showRegionSelection(BuildContext context, AddAddressBuildable state) {
  ...
  _showDistrictSelection(BuildContext context, AddAddressBuildable state) {
    showModalBottomSheet(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10.0),
      ),
  ...
  _showNeighborhoodSelection(BuildContext context, AddAddressBuildable state) {
    showModalBottomSheet(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10.0),
      ),
