    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        children: [
          ...
          ProfileItemWidget(
              name: 'Заказы',
              icon: Assets.images.profile.icOrder.svg(width: 18, height: 18),
          ...
          ProfileItemWidget(
              name: 'Платежи',
              icon: Assets.images.profile.icPayment.svg(width: 18, height: 18),
              callback: () => context.router.push(PaymentTransactionRoute())),
          Divider(indent: 46, height: 1),
          ProfileItemWidget(
          ...
          ProfileItemWidget(
              name: 'Мои адреса',
              icon: Assets.images.profile.icLocation.svg(width: 18, height: 18),
              callback: () => context.router.push(AddAddressRoute())),
          Divider(indent: 46, height: 1),
          ProfileItemWidget(
              name: 'Продвижения',
              icon:
                  Assets.images.profile.icPromotion.svg(width: 18, height: 18),
